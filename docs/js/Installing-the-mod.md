...
1.  Extract the DDLC zip file into a new folder. This will be your game directory.
2.  Extract the Just Sayori mod zip file.
3.  Open the extracted mod folder. Select all files and folders within it and copy them.
4.  Paste the copied files into your game directory (the folder where you extracted DDLC). When prompted, choose to replace any existing files.
5.  Navigate into the `game` subfolder inside your game directory.
6.  Delete the file named `scripts.rpa`.
    *   **Why?** This file contains the original DDLC script. Deleting it allows the mod's scripts to run without problems.
